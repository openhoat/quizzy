...
describe('quizzy routes', function() {
  ...
  [
    ...
    describe(`${store.name} store`, () => {
      ...
      after(() => store.deleteAll()
        .finally(() => store.stop())
      )

      it('should return an error when getting a bad uri', () => testHelper
        .request({
          method: 'get',
          url: `/api/baduri`,
          json: true,
      ...
      it('should return an error when posting incomplete quiz', () => testHelper
        .request({
          method: 'POST',
          url: '/api/quizzes',
      ...
      it('should post president quiz', () => {
        ...
        return testHelper.request(req, quizzy)
          .spread((body, res) => {
            log.warn('body :', body)
      ...
      it('should return an error when getting a bad quiz id', () => testHelper
        .request({
          method: 'get',
